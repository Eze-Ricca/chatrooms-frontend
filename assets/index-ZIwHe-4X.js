var mC=Object.defineProperty;var vC=(i,e,n)=>e in i?mC(i,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):i[e]=n;var Qo=(i,e,n)=>vC(i,typeof e!="symbol"?e+"":e,n);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const u of l.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&s(u)}).observe(document,{childList:!0,subtree:!0});function n(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(a){if(a.ep)return;a.ep=!0;const l=n(a);fetch(a.href,l)}})();class yC extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){var f,_;const e=document.createElement("button"),n=this.getAttribute("label")||"Click Me",s=this.getAttribute("bg-color")||"#9CBBE9",a=this.getAttribute("text-color")||"#fff",l=this.getAttribute("border-color")||"none",u=document.createElement("style");u.textContent=`
    ...
    `,e.appendChild(n),e.appendChild(s),(a=this.shadowRoot)==null||a.appendChild(e)}}customElements.define("header-el",wC);class CC extends HTMLElement{constructor(){super();Qo(this,"inputElement");this.attachShadow({mode:"open"})}connectedCallback(){var C,E;const n=document.createElement("div"),s=document.createElement("input"),a=document.createElement("label"),l=this.getAttribute("label")||"",u=this.getAttribute("size-label")||"18px",f=this.getAttribute("placeholder")||"Escribe aqui...",_=this.getAttribute("type")||"text",g=this.hasAttribute("required");a.textContent=l,s.placeholder=f,s.type=_,g?s.required=!0:s.required=!1,this.inputElement=s;const b=document.createElement("style");b.textContent=`
    div {
        margin-bottom: 10px;
    ...
    `,n.appendChild(a),n.appendChild(s),(C=this.shadowRoot)==null||C.appendChild(b),(E=this.shadowRoot)==null||E.appendChild(n)}getValue(){return this.inputElement.value}setValue(n){this.inputElement.value=n}}customElements.define("reusable-input",CC);class EC extends HTMLElement{constructor(){super();Qo(this,"selectElement");this.attachShadow({mode:"open"})}connectedCallback(){var b,C;const n=document.createElement("div"),s=document.createElement("select"),a=document.createElement("label"),l=this.getAttribute("label")||"Etiqueta",u=this.getAttribute("size-label")||"18px",f=this.getAttribute("options")||"Opción 1,Opción 2,Opción 3";a.textContent=l,f.split(",").forEach(E=>{const A=document.createElement("option");A.value=E,A.textContent=E,s.appendChild(A)}),this.selectElement=s,this.selectElement.addEventListener("change",()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))});const g=document.createElement("style");g.textContent=`
      div {
          margin-bottom: 10px;
      }
      label {
      ...
      `,n.appendChild(a),n.appendChild(s),(b=this.shadowRoot)==null||b.appendChild(g),(C=this.shadowRoot)==null||C.appendChild(n)}getValue(){return this.selectElement?this.selectElement.value:(console.warn("Select element not found in reusable-select"),"")}}customElements.define("reusable-select",EC);const bC=()=>{};var qu={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function MC(i,e){if(i.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const n={alg:"none",type:"JWT"},s=e||"demo-project",a=i.iat||0,l=i.sub||i.user_id;if(!l)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const u=Object.assign({iss:`https://securetoken.google.com/${s}`,aud:s,iat:a,exp:a+3600,auth_time:a,sub:l,user_id:l,firebase:{sign_in_provider:"custom",identities:{}}},i);return[Jr(JSON.stringify(n)),Jr(JSON.stringify(u)),""].join(".")}const xi={};function kC(){const i={prod:[],emulator:[]};for(const e of Object.keys(xi))xi[e]?i.emulator.push(e):i.prod.push(e);return i}function FC(i){let e=document.getElementById(i),n=!1;return e||(e=document.createElement("div"),e.setAttribute("id",i),n=!0),{created:n,element:e}}let Gu=!1;function BC(i,e){if(typeof window>"u"||typeof document>"u"||!Na(window.location.host)||xi[i]===e||xi[i]||Gu)return;xi[i]=e;function n(E){return`__firebase__banner__${E}`}const s="__firebase__banner",l=kC().prod.length>0;function u(){const E=document.getElementById(s);E&&E.remove()}function f(E){E.style.display="flex",E.style.background="#7faaf0",E.style.position="fixed",E.style.bottom="5px",E.style.left="5px",E.style.padding=".5em",E.style.borderRadius="5px",E.style.alignItems="center"}function _(E,A){E.setAttribute("width","24"),E.setAttribute("id",A),E.setAttribute("height","24"),E.setAttribute("viewBox","0 0 24 24"),E.setAttribute("fill","none"),E.style.marginLeft="-6px"}function g(){const E=document.createElement("span");return E.style.cursor="pointer",E.style.marginLeft="16px",E.style.fontSize="24px",E.innerHTML=" &times;",E.onclick=()=>{Gu=!0,u()},E}function b(E,A){E.setAttribute("id",A),E.innerText="Learn more",E.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",E.setAttribute("target","__blank"),E.style.paddingLeft="5px",E.style.textDecoration="underline"}function C(){const E=FC(s),A=n("text"),D=document.getElementById(A)||document.createElement("span"),$=n("learnmore"),G=document.getElementById($)||document.createElement("a"),ue=n("preprendIcon"),Me=document.getElementById(ue)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(E.created){const Ie=E.element;f(Ie),b(G,$);const yt=g();_(Me,ue),Ie.append(Me,D,G,yt),document.body.appendChild(Ie)}l?(D.innerText="Preview backend disconnected.",Me.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
...
</defs>`,D.innerText="Preview backend running in this workspace."),D.setAttribute("id",A)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",C):C()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _1=Math.log(2);class g1{constructor(e){const n=l=>parseInt(Math.log(l)/_1,10),s=l=>parseInt(Array(l+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const a=s(this.count);this.bits_=e+1&a}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const rs=function(i,e,n,s){i.sort(e);const a=function(_,g){const b=g-_;let C,E;if(b===0)return null;if(b===1)return C=i[_],E=n?n(C):C,new Ee(E,C.node,Ee.BLACK,null,null);{const A=parseInt(b/2,10)+_,D=a(_,A),$=a(A+1,g);return C=i[A],E=n?n(C):C,new Ee(E,C.node,Ee.BLACK,D,$)}},l=function(_){let g=null,b=null,C=i.length;const E=function(D,$){const G=C-D,ue=C;C-=D;const Me=a(G+1,ue),Ie=i[G],yt=n?n(Ie):Ie;A(new Ee(yt,Ie.node,$,null,Me))},A=function(D){g?(g.left=D,g=D):(b=D,g=D)};for(let D=0;D<_.count;++D){const $=_.nextBitIsOne(),G=Math.pow(2,_.count-(D+1));$?E(G,Ee.BLACK):(E(G,Ee.BLACK),E(G,Ee.RED))}return b},u=new g1(i.length),f=l(u);return new He(s||e,f)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const v1=!0;function Ne(i,e=null){if(i===null)return B.EMPTY_NODE;if(typeof i=="object"&&".priority"in i&&(e=i[".priority"]),N(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof i=="object"&&".value"in i&&i[".value"]!==null&&(i=i[".value"]),typeof i!="object"||".sv"in i){const n=i;return new Ce(n,Ne(e))}if(!(i instanceof Array)&&v1){const n=[];let s=!1;if($e(i,(u,f)=>{if(u.substring(0,1)!=="."){const _=Ne(f);_.isEmpty()||(s=s||!_.getPriority().isEmpty(),n.push(new V(u,_)))}}),n.length===0)return B.EMPTY_NODE;const l=rs(n,u1,u=>u.name,Wa);if(s){const u=rs(n,de.getCompare());return new B(l,Ne(e),new Dt({".priority":u},{".priority":de}))}else return new B(l,Ne(e),Dt.Default)}else{let n=B.EMPTY_NODE;return $e(i,(s,a)=>{if(Ft(i,s)&&s.substring(0,1)!=="."){const l=Ne(a);(l.isLeafNode()||!l.isEmpty())&&(n=n.updateImmediateChild(s,l))}}),n.updatePriority(Ne(e))}}f1(Ne);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ha{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=de}hasStart(){return this.startSet_}isViewFromLeft(){return this.viewFrom_===""?this.startSet_:this.viewFrom_==="l"}getIndexStartValue(){return N(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return N(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:zn}hasEnd(){return this.endSet_}getIndexEndValue(){return N(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return N(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:dn}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&this.viewFrom_!==""}getLimit(){return N(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===de}copy(){const e=new Ha;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function I1(i){return i.loadsAllData()?new Ua(i.getIndex()):i.hasLimit()?new b1(i):new Wi(i)}function vh(i){const e={};if(i.isDefault())return e;let n;if(i.index_===de?n="$priority":i.index_===C1?n="$value":i.index_===$n?n="$key":(N(i.index_ instanceof y1,"Unrecognized index type!"),n=i.index_.toString()),e.orderBy=be(n),i.startSet_){const s=i.startAfterSet_?"startAfter":"startAt";e[s]=be(i.indexStartValue_),i.startNameSet_&&(e[s]+=","+be(i.indexStartName_))}if(i.endSet_){const s=i.endBeforeSet_?"endBefore":"endAt";e[s]=be(i.indexEndValue_),i.endNameSet_&&(e[s]+=","+be(i.indexEndName_))}return i.limitSet_&&(i.isViewFromLeft()?e.limitToFirst=i.limit_:e.limitToLast=i.limit_),e}function yh(i){const e={};if(i.startSet_&&(e.sp=i.indexStartValue_,i.startNameSet_&&(e.sn=i.indexStartName_),e.sin=!i.startAfterSet_),i.endSet_&&(e.ep=i.indexEndValue_,i.endNameSet_&&(e.en=i.indexEndName_),e.ein=!i.endBeforeSet_),i.limitSet_){e.l=i.limit_;let n=i.viewFrom_;n===""&&(i.isViewFromLeft()?n="l":n="r"),e.vf=n}return i.index_!==de&&(e.i=i.index_.toString()),e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class x1{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),n=Object.assign({},e);return this.last_&&$e(this.last_,(s,a)=>{n[s]=n[s]-a}),this.last_=e,n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let fs;function mb(i){N(!fs,"__referenceConstructor has already been defined"),fs=i}function vb(){return N(fs,"Reference.ts has not been loaded"),fs}let yb=1;class Nh{constructor(e){this.listenProvider_=e,this.syncPointTree_=new le(null),this.pendingWriteTree_=K1(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function wb(i,e,n,s,a){return k1(i.pendingWriteTree_,e,n,s,a),a?Yi(i,new pn(Mf(),e,n)):[]}function Wn(i,e,n=!1){const s=F1(i.pendingWriteTree_,e);if(B1(i.pendingWriteTree_,e)){let l=new le(null);return s.snap!=null?l=l.set(j(),!0):$e(s.children,u=>{l=l.set(new ie(u),!0)}),Yi(i,new as(s.path,l,n))}else return[]}function ws(i,e,n){return Yi(i,new pn($a(),e,n))}function Cb(i,e,n){const s=le.fromObject(n);return Yi(i,new Hi($a(),e,s))}function Eb(i,e){return Yi(i,new Ui($a(),e))}function bb(i,e,n){const s=Qa(i,n);if(s){const a=Xa(s),l=a.path,u=a.queryId,f=Ue(l,e),_=new Ui(qa(u),f);return Ja(i,l,_)}else return[]}function Ea(i,e,n,s,a=!1){const l=e._path,u=i.syncPointTree_.get(l);let f=[];if(u&&(e._queryIdentifier==="default"||Kf(u,e))){const _=gb(u,e,n,s);db(u)&&(i.syncPointTree_=i.syncPointTree_.remove(l));const g=_.removed;if(f=_.events,!a){const b=g.findIndex(E=>E._queryParams.loadsAllData())!==-1,C=i.syncPointTree_.findOnPath(l,(E,A)=>Jt(A));if(b&&!C){const E=i.syncPointTree_.subtree(l);if(!E.isEmpty()){const A=Tb(E);for(let D=0;D<A.length;++D){const $=A[D],G=$.query,ue=Jf(i,$);i.listenProvider_.startListening(Di(G),ds(i,G),ue.hashFn,ue.onComplete)}}}!C&&g.length>0&&!s&&(b?i.listenProvider_.stopListening(Di(e),null):g.forEach(E=>{const A=i.queryToTagMap.get(Cs(E));i.listenProvider_.stopListening(Di(E),A)}))}xb(i,g)}return f}function Ib(i,e,n,s){const a=Qa(i,s);if(a!=null){const l=Xa(a),u=l.path,f=l.queryId,_=Ue(u,e),g=new pn(qa(f),_,n);return Ja(i,u,g)}else return[]}function Sb(i,e,n,s){const a=Qa(i,s);if(a){const l=Xa(a),u=l.path,f=l.queryId,_=Ue(u,e),g=le.fromObject(n),b=new Hi(qa(f),_,g);return Ja(i,u,b)}else return[]}function Oh(i,e,n,s=!1){const a=e._path;let l=null,u=!1;i.syncPointTree_.foreachOnPath(a,(E,A)=>{const D=Ue(E,a);l=l||qn(A,D),u=u||Jt(A)});let f=i.syncPointTree_.get(a);f?(u=u||Jt(f),l=l||qn(f,j())):(f=new ub,i.syncPointTree_=i.syncPointTree_.set(a,f));let _;l!=null?_=!0:(_=!1,l=B.EMPTY_NODE,i.syncPointTree_.subtree(a).foreachChild((A,D)=>{const $=qn(D,j());$&&(l=l.updateImmediateChild(A,$))}));const g=Kf(f,e);if(!g&&!e._queryParams.loadsAllData()){const E=Cs(e);N(!i.queryToTagMap.has(E),"View does not exist, but we have a tag");const A=Rb();i.queryToTagMap.set(E,A),i.tagToQueryMap.set(A,E)}const b=Ga(i.pendingWriteTree_,a);let C=_b(f,e,n,b,l,_);if(!g&&!u&&!s){const E=Vf(f,e);C=C.concat(Ab(i,e,E))}return C}function Yf(i,e,n){const a=i.pendingWriteTree_,l=i.syncPointTree_.findOnPath(e,(u,f)=>{const _=Ue(u,e),g=qn(f,_);if(g)return g});return Wf(a,e,l,n,!0)}function Yi(i,e){return Qf(e,i.syncPointTree_,null,Ga(i.pendingWriteTree_,j()))}function Qf(i,e,n,s){if(Q(i.path))return Xf(i,e,n,s);{const a=e.get(j());n==null&&a!=null&&(n=qn(a,j()));let l=[];const u=Y(i.path),f=i.operationForChild(u),_=e.children.get(u);if(_&&f){const g=n?n.getImmediateChild(u):null,b=Uf(s,u);l=l.concat(Qf(f,_,g,b))}return a&&(l=l.concat(Ya(a,i,s,n))),l}}function Xf(i,e,n,s){const a=e.get(j());n==null&&a!=null&&(n=qn(a,j()));let l=[];return e.children.inorderTraversal((u,f)=>{const _=n?n.getImmediateChild(u):null,g=Uf(s,u),b=i.operationForChild(u);b&&(l=l.concat(Xf(b,f,_,g)))}),a&&(l=l.concat(Ya(a,i,s,n))),l}function Jf(i,e){const n=e.query,s=ds(i,n);return{hashFn:()=>(ob(e)||B.EMPTY_NODE).hash(),onComplete:a=>{if(a==="ok")return s?bb(i,n._path,s):Eb(i,n._path);{const l=bE(a,n);return Ea(i,n,null,l)}}}}function ds(i,e){const n=Cs(e);return i.queryToTagMap.get(n)}function Cs(i){return i._path.toString()+"$"+i._queryIdentifier}function Qa(i,e){return i.tagToQueryMap.get(e)}function Xa(i){const e=i.indexOf("$");return N(e!==-1&&e<i.length-1,"Bad queryKey."),{queryId:i.substr(e+1),path:new ie(i.substr(0,e))}}function Ja(i,e,n){const s=i.syncPointTree_.get(e);N(s,"Missing sync point for query tag that we're tracking");const a=Ga(i.pendingWriteTree_,e);return Ya(s,n,a,null)}function Tb(i){return i.fold((e,n,s)=>{if(n&&Jt(n))return[ys(n)];{let a=[];return n&&(a=zf(n)),$e(s,(l,u)=>{a=a.concat(u)}),a}})}function Di(i){return i._queryParams.loadsAllData()&&!i._queryParams.isDefault()?new(vb())(i._repo,i._path):i}function xb(i,e){for(let n=0;n<e.length;++n){const s=e[n];if(!s._queryParams.loadsAllData()){const a=Cs(s),l=i.queryToTagMap.get(a);i.queryToTagMap.delete(a),i.tagToQueryMap.delete(l)}}}function Rb(){return yb++}function Ab(i,e,n){const s=e._path,a=ds(i,e),l=Jf(i,n),u=i.listenProvider_.startListening(Di(e),a,l.hashFn,l.onComplete),f=i.syncPointTree_.subtree(s);if(a)N(!Jt(f.value),"If we're adding a query, it shouldn't be shadowed");else{const _=f.fold((g,b,C)=>{if(!Q(g)&&b&&Jt(b))return[ys(b).query];{let E=[];return b&&(E=E.concat(zf(b).map(A=>A.query))),$e(C,(A,D)=>{E=E.concat(D)}),E}});for(let g=0;g<_.length;++g){const b=_[g];i.listenProvider_.stopListening(Di(b),ds(i,b))}}return u}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bb=/[\[\].#$\/\u0000-\u001F\u007F]/,Wb=/[\[\].#$\u0000-\u001F\u007F]/,sa=10*1024*1024,td=function(i){return typeof i=="string"&&i.length!==0&&!Bb.test(i)},nd=function(i){return typeof i=="string"&&i.length!==0&&!Wb.test(i)},Ub=function(i){return i&&(i=i.replace(/^\/*\.info(\/|$)/,"/")),nd(i)},id=function(i,e,n){const s=n instanceof ie?new n1(n,i):n;if(e===void 0)throw new Error(i+"contains undefined "+hn(s));if(typeof e=="function")throw new Error(i+"contains a function "+hn(s)+" with contents = "+e.toString());if(nf(e))throw new Error(i+"contains "+e.toString()+" "+hn(s));if(typeof e=="string"&&e.length>sa/3&&_s(e)>sa)throw new Error(i+"contains a string greater than "+sa+" utf8 bytes "+hn(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let a=!1,l=!1;if($e(e,(u,f)=>{if(u===".value")a=!0;else if(u!==".priority"&&u!==".sv"&&(l=!0,!td(u)))throw new Error(i+" contains an invalid key ("+u+") "+hn(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);i1(s,u),id(i,f,s),r1(s)}),a&&l)throw new Error(i+' contains ".value" child '+hn(s)+" in addition to actual children.")}},rd=function(i,e,n,s){if(!nd(n))throw new Error(Kh(i,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Hb=function(i,e,n,s){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),rd(i,e,n)},$b=function(i,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!td(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!Ub(n))throw new Error(Kh(i,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`)+R+`return __p
 ...
 <main class="main">
  ...
  `,console.log("Entré a home");const s=e.querySelector(".select-roomid"),a=e.querySelector(".input-email"),l=e.querySelector(".input-name"),u=e.querySelector(".input-roomid"),f=e.querySelector(".button"),_=e.querySelector(".error-message-email"),g=e.querySelector(".error-message-name"),b=e.querySelector(".error-message-roomid");return u.style.display="none",s.addEventListener("change",()=>{const C=s.getValue().trim();u.style.display=C==="Ingresa a una Sala conocida"?"block":"none"}),u.style.display=s.getValue().trim()==="Ingresa a una Sala conocida"?"block":"none",f.addEventListener("click",C=>{C.preventDefault();const E=a.getValue().trim(),A=l.getValue().trim(),D=u.getValue().trim(),$=s.getValue().trim();if(_.style.display="none",g.style.display="none",b.style.display="none",!E){_.textContent="Por favor, ingrese un Email antes de continuar.",_.style.display="block";return}if(!A){g.textContent="Por favor, ingrese un nombre antes de continuar.",g.style.display="block";return}if($==="Ingresa a una Sala conocida"&&!D){b.textContent="Por favor, ingrese un RoomId válido.",b.style.display="block";return}Le.setEmailAndFullName(E,A),$==="Crea una sala"?Le.signIn(G=>{if(G){console.error("hubo un error");return}Le.askNewRoom(()=>{Le.getState().roomId?Le.accessToRoom(()=>{i.goTo("/chat")}):alert("No se pudo obtener el Room ID")})}):$==="Ingresa a una Sala conocida"&&(Le.getState().roomId=D,Le.signIn(G=>{if(G){console.error("hubo un error");return}Le.getState().roomId?Le.accessToRoom(()=>{i.goTo("/chat")}):alert("No se pudo obtener el Room ID")}))}),e.appendChild(n),e}const $I={apiKey:"QLrNSjLc0rVOo6LZ35zofmPWHYnlLLxc3nt2NQWO",databaseURL:"https://chats-rooms-9a40f-default-rtdb.firebaseio.com/",authDomain:"chats-rooms-9a40f.firebaseapp.com"},qI=Da($I),GI=gd(qI);function zI(){const i=Le.getState();console.log(Le.getState());const e=document.createElement("div");e.innerHTML=`
   <header-el></header-el>
  <main class="main">
  <h2>Chat</h2>
  ...
  `;const a=Le.getState().realtimeDBRoomId;function l(u){Le.pushMessage(u),console.log("Mensaje enviado correctamente!")}return(()=>{const u=pd(GI,`/rooms/${a}/messages`);_d(u,g=>{const b=g.val()||{},C=e.querySelector(".container-messages");C.innerHTML="";function E(){C.scrollTop=C.scrollHeight}Object.values(b).forEach(A=>{const D=document.createElement("li"),G=new Date(A.timestamp).toLocaleTimeString("es-AR",{hour:"2-digit",minute:"2-digit"}),ue=A.author===Le.data.nombre;D.classList.add(ue?"usuario-message":"otro-message"),D.innerHTML=`
        <div class="container-mesagge">
          <p class="name-message"><em>${A.author}</em></p>
          <p class="container-mesagge-msg">${A.text}</p>
          <p class="hour-message"><em>${G}</em></p>
        </div>
        `,C.appendChild(D),E()})});const f=e.querySelector(".input-mesagge"),_=e.querySelector(".button");_==null||_.addEventListener("click",()=>{const g=f.getValue();g.trim()!==""&&(l(g),f.setValue(""))}),f.addEventListener("keypress",g=>{if(g.key==="Enter"){g.preventDefault();const b=f.getValue();b.trim()!==""&&(l(b),f.setValue(""))}})})(),e.appendChild(n),e}const $i=document.querySelector("#app");if(!$i)throw new Error("Elemento #app no encontrado");const VI=location.hostname==="localhost"||location.hostname==="127.0.0.1"||location.hostname.startsWith("192.168.")||location.hostname==="[::1]";VI||Zt.base("/chatrooms-frontend");function KI(i){Zt(i)}Zt("/",()=>Zt.redirect("/home"));Zt("/home",()=>{$i.innerHTML="",$i.appendChild(HI({goTo:KI}))});Zt("/chat",()=>{$i.innerHTML="",$i.appendChild(zI())});function YI(){Zt.start()}YI(),Le.init();
